...
class TestImageService:
    ...
    def test_create_thumbnail(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_generate_character_sheet_passes_system_instruction(self, working_folder: Path, mock_genai):
        ...
        expected_system_instruction += "\n\n" + style_prefix.format(style_prompt="Fantasy illustration style")
        
        assert getattr(config, "system_instruction", None) == expected_system_instruction
    ...
    @pytest.mark.asyncio
    async def test_generate_image_emits_progress(self, working_folder: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_generate_image_reports_usage_metadata(self, working_folder: Path, mock_genai):
        usage_cb = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_generate_image_concurrent_lock(self, working_folder: Path, mock_genai):
...
class TestImageServiceErrors:
    ...
    async def test_generate_image_api_error(self, working_folder: Path, mock_genai):
        ...
        mock_genai.Client.return_value.models.generate_content_stream.side_effect = Exception(
            "API Error"
        )
    ...
    @pytest.mark.asyncio
    async def test_generate_image_rejects_empty_prompt(self, working_folder: Path, mock_genai):
        service = ImageService("test-api-key", working_folder)
    ...
    @pytest.mark.asyncio
    async def test_generate_image_rejects_overlong_prompt(self, working_folder: Path, mock_genai):
        service = ImageService("test-api-key", working_folder)
...
class TestImageServiceRework:
    ...
    @pytest.mark.asyncio
    async def test_rework_image_basic(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_preserves_original(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_uses_correct_system_prompt(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_includes_original_as_reference(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_with_additional_references(self, working_folder: Path, sample_images: list[Path], mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_reports_usage(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_missing_original_raises_error(self, working_folder: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_image_filename_format(self, working_folder: Path, sample_image: Path, mock_genai):
    ...
    @pytest.mark.asyncio
    async def test_rework_emits_progress(self, working_folder: Path, sample_image: Path, mock_genai):
