...
def sample_project_data() -> dict:
    ...
    return {
        "pages": [
            {"id": "page001", "path": "pages/page_0.png", "category": "pages", "name": "Page 1", "order": 1},
            {"id": "page002", "path": "pages/page_1.png", "category": "pages", "name": "Page 2", "order": 2},
        ],
        "characters": [
            {"id": "char001", "path": "characters/char_0.png", "category": "characters", "name": "Hero"},
        ],
        "references": [
            {"id": "ref001", "path": "input/reference_0.jpg", "category": "references", "name": "Photo 1"},
        ],
    }
